...
///////////////////////////////////////
const url = `https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604691c37cdc054bd015`;
...
const showRecipe = async function() {
    try {
        ...
        if (!res.ok) throw Error(`${recipeData.message} ${res.status}`);
...
},{}]},["lxCDu","aenu9"], "aenu9", "parcelRequiree37b")
